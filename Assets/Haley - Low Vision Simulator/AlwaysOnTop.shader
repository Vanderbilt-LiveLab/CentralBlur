...
Shader "Custom/AlwaysOnTop" {
    ...
    SubShader{
        ...
        Pass
        {
            ...
            // Unity Stereo View and Projection Matrices
            uniform float4x4 unity_StereoMatrixVP[2];
            ...
            v2f vert(appdata_t v)
            {
                v2f o;
                    ...
                    // Get the correct stereo eye index
                    int eyeIndex = unity_StereoEyeIndex;
                    // Use the stereo view and projection matrices
                    o.vertex = mul(unity_StereoMatrixVP[eyeIndex], v.vertex);
                #else
